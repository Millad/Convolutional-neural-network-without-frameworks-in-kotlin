...
object App {
        ...
        fun main(args: Array<String>) {
            ...
            println("Trening :::::::::::::::::::::::::::::::::")
            val vekterTrent = trening(vertikalBildeMatrise, kernelStorrelse,  maal, alpha,antallTreningsrunder, vekterStorrelse ).vekterTrent
            ...
            val feil_prosent_gitt_riktig_bilde = (verifisering_lag_2 - maal).pow(2)
    ...
    fun trening(vertikalBildeMatrise: Matrise, kernelStorrelse: Int,  maal: Int, alpha: Double, antallOpplæringsrunder:Int, vekterStorrelse:Int):TreningResultat {
